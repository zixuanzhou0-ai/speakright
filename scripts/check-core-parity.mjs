...
const pairs = [
  ...
  "lib/guided-repeat-plan.ts",
  "lib/guided-repeat-audio.ts",
  "lib/tauri-runtime.ts",
  "hooks/use-guided-repeat-session.ts",
  "hooks/use-azure-assessment.ts",
  "hooks/use-tts-aligned.ts",
  "lib/cloud-processing-consent.ts",
  "components/common/cloud-processing-disclosure.tsx",
  "components/audio/read-along-text.tsx",
  "components/layout/theme-toggle.tsx",
  "components/ui/slider.tsx",
  "components/sentences/sentence-input-card.tsx",
  "components/phoneme/phoneme-card.tsx",
  "app/sentences/page.tsx",
  "app/assessment/page.tsx",
  "app/drill/perception/page.tsx",
  "app/drill/prosody/page.tsx",
  "app/progress/page.tsx",
  "components/phoneme/guided-repeat-experience.tsx",
  "components/phoneme/phoneme-study-card.tsx",
...
const wrappers = [
  ...
  "src/lib/guided-repeat-plan.ts",
  "apps/browser/src/lib/guided-repeat-plan.ts",
