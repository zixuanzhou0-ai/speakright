...
import { getPerceptionCatalogEntry } from "./training-perception";
...
export const TRAINING_PACKS: TrainingPack[] = [
  {
    ...
    l1Problem:
      "普通话通常没有与英语 /ɪ/ 完全对应的独立音位，部分学习者可能把 ship 和 sheep 说得过于接近。",
    mouthCue:
      "/iː/ 舌前部高抬且较紧；/ɪ/ 舌位略低略后、较放松。先建立音质差异，再观察语境中的自然时长。",
    perceptionItems: [
      {
        wordA: "sleep",
        wordB: "swim",
    ...
    wordLadder: [
      item("sleep", "/sliːp/", "ee", "舌位高前、舌体较紧，再干净收住 /p/。"),
    ...
    sentenceLadder: [
      ...
      item(
        ...
        "",
        "ih",
        "seat 的 /iː/ 较高前、较紧；sit 和 this 的 /ɪ/ 稍低后、较松，时长只作辅助线索。",
      ),
      item(
        "I will leave it in the kitchen.",
        "",
        "ih",
        "leave 保持较高前、较紧的 /iː/；it、in、kitchen 的 /ɪ/ 更松。",
      ),
    ],
  ...
  },
  {
    ...
    l1Problem:
      "普通话没有与英语 /æ/ 完全对应的独立音位，部分学习者可能把口腔开度收小，使 man 接近 men。",
    mouthCue:
  ...
  },
  {
    ...
    contrastPhonemes: ["s"],
    l1Problem:
      "普通话通常没有齿间擦音这一独立音位，部分学习者可能用 /s/ 等更熟悉的动作替代 /θ/；需要通过对比任务验证。",
    mouthCue:
    ...
    sentenceLadder: [
      item(
        ...
        "",
        "th",
        "think/three/things 都要伸舌。",
      ),
      item(
        "The path is narrow but smooth.",
        "",
        "th",
        "path 词尾 /θ/ 不要读成 /s/。",
      ),
  ...
  },
  {
    ...
    contrastPhonemes: ["z"],
    l1Problem:
      "部分普通话学习者可能把 /ð/ 接近 /z/ 或 /d/；具体替代方向需要由多次对比录音确认。",
    mouthCue: "舌尖像 /θ/ 一样放在齿间，但声带要振动。手摸喉咙，应能感觉震动。",
    perceptionItems: [
      {
        wordA: "zen",
        wordB: "then",
    ...
    sentenceLadder: [
      ...
      item(
        "My father said the weather was pleasant.",
        "",
        "dh",
        "father/the/weather 连续保持 /ð/。",
      ),
      item(
  ...
  },
  {
    ...
    l1Problem:
      "部分普通话学习者可能混淆 /v/ 与 /w/ 的唇齿、圆唇动作；先观察动作与多词境结果，不预设固定替代音。",
    mouthCue:
    ...
    sentenceLadder: [
      item(
        "Very few visitors waited outside.",
        "",
        "v",
        "very/visitors 用 /v/，waited 用 /w/。",
      ),
      item(
        "We watched a video about waves.",
        "",
        "w",
        "we/watched/waves 双唇收圆。",
      ),
      item(
        "The voice was warm and vivid.",
        "",
        "v",
        "voice/vivid 是 /v/，warm 是 /w/。",
      ),
    ],
    masteryRule: DEFAULT_RULE,
    estimatedMinutes: 14,
  },
  {
    ...
    sentenceLadder: [
      item(
        "The red light is really bright.",
        "",
        "r",
        "red/really/bright 和 light 对比。",
      ),
      item(
        "Please read the long list clearly.",
        "",
        "l",
        "read 是 /r/，long/list/clearly 有 /l/。",
      ),
      item(
        "The world feels larger after travel.",
        "",
        "l",
        "world/feels/larger 保持 L 和 R 区分。",
      ),
    ],
    masteryRule: DEFAULT_RULE,
    estimatedMinutes: 16,
  },
  {
    ...
    l1Problem:
      "普通话的音节尾类型与英语不同，部分学习者可能弱化词尾辅音或加入额外元音；是否出现需由录音确认。",
    mouthCue:
    ...
    sentenceLadder: [
      item(
        "I asked for help with the books.",
        "",
        "t",
        "asked/help/books 词尾都要收住。",
      ),
      item(
        "The world looked quiet and cold.",
        "",
        "d",
        "world/looked/cold 不要吞尾。",
      ),
      item(
        "Please keep the cup on the desk.",
        "",
        "p",
        "keep/cup/desk 结尾短促。",
      ),
  ...
  },
  {
    ...
    l1Problem:
      "普通话与英语的节奏组织不同，部分学习者可能平均分配时长；英语训练需同时关注重音突出、弱读和词间连接。",
    mouthCue:
    ...
    sentenceLadder: [
      item(
        ...
        "",
        "schwa",
        "want to 连成 wanna 的感觉，about 开头弱。",
      ),
      item(
        "She is going to pick it up.",
        "",
        "schwa",
        "going to 弱化，pick it up 连读。",
      ),
      item(
        "A cup of coffee is on the table.",
        "",
        "schwa",
        "a/of/the 弱读，coffee/table 重读。",
      ),
    ],
    masteryRule: DEFAULT_RULE,
    estimatedMinutes: 18,
  },
  {
    ...
    l1Problem:
      "部分学习者可能让 /ʊ/ 过于接近 /uː/；关键差异还包括舌位、音质和圆唇程度，时长只是线索之一。",
    mouthCue:
    ...
    wordLadder: [
      item(
        ...
        "/puːl/",
        "oo",
        "/uː/ 舌位较高后、圆唇更明显，最后 dark L 收住。",
      ),
      item(
        "pull",
        "/pʊl/",
        "uh",
        "/ʊ/ 稍低前、较松且圆唇较弱，不要只靠缩短时长。",
      ),
    ...
    sentenceLadder: [
      item(
        "Look at the pool near the school.",
        "",
        "uh",
        "look 短，pool/school 长。",
      ),
      item(
        "The full moon looked blue.",
        "",
        "oo",
        "full/looked 短，moon/blue 长。",
      ),
      item(
        "Put the food on the wooden table.",
        "",
        "uh",
        "put/wooden 短，food 长。",
      ),
  ...
  },
  {
    ...
    l1Problem:
      "部分普通话学习者可能在 /n/ 与 /ŋ/ 的舌尖、舌后动作间迁移；需要用不同词位和相邻音验证。",
    mouthCue: "/n/ 舌尖抵上齿龈，气从鼻子出；/ŋ/ 舌尖放下，舌根抬起贴软腭。",
    perceptionItems: [
      {
        wordA: "sin",
        wordB: "sing",
    ...
    sentenceLadder: [
      ...
      item(
        ...
        "",
        "ng",
        "language 和 interesting 有 /ŋ/。",
      ),
      item(
        "Bring the ring in the morning.",
        "",
        "ng",
        "bring/ring/morning 保持后鼻音。",
      ),
    ],
    masteryRule: DEFAULT_RULE,
    estimatedMinutes: 14,
...
const CURATED_COURSE_BANK: Record<string, CuratedCourseBank> = {
  "ee-ih": {
    ...
    sentences: [
      seed(
        "The seat is near the ship.",
        ["ee", "ih"],
        "seat 的 /iː/ 较高前、较紧；ship 的 /ɪ/ 稍低后、较松。",
        "两个元音只用时长区分，音质仍相同。",
        "不用上下文也能分出两个元音类别。",
        2,
        "mixed",
      ...
      seed(
        "Please sit in this seat.",
        ["ee", "ih"],
        "please/seat 保持 /iː/ 音质，sit/this 保持较松的 /ɪ/。",
        "this 的舌位抬得过高前。",
        "音质对比自然，时长随语境变化。",
        2,
        "mixed",
      ...
      seed(
        ...
        ["ee", "ih"],
        "meeting 长，finish/fifteen 里短音要短。",
        "所有 i 都读成一种音。",
        "多音节里长短稳定。",
        5,
        "mixed",
      ...
      seed(
        ...
        ["ee", "ih"],
        "we/need/clean/sheets 保持 /iː/ 音质，six 保持较松的 /ɪ/。",
        "six 被收得过紧，接近 /iː/。",
        "six 的元音和 /ks/ 都清楚。",
        5,
        "mixed",
    ...
    shadowing: [
      seed(
        ...
        ["ee", "ih"],
        "跟读时保持 seat/feet 长，sit/this/still 短。",
        "只模仿速度，长短全丢。",
        "自然语速里长短仍清楚。",
        4,
        "mixed",
      ...
      seed(
        ...
        ["ee", "ih"],
        "leave/evening 长，list/kitchen/this 短。",
        "快读时 list 变成 least。",
        "句子速度上来后仍不混。",
        5,
        "mixed",
  ...
  "eh-ae": {
    ...
    sentences: [
      seed(
        "The bad man sat on the bed.",
        ["ae", "eh"],
        "bad/man/sat 大开口，bed 小开口。",
        "全都读成 /e/。",
        "开口差异贯穿整句。",
        2,
        "mixed",
      ...
      seed(
        "Ben packed a red bag.",
        ["eh", "ae"],
        "Ben/red 小，packed/bag 大。",
        "packed 的 /æ/ 开口不足。",
        "短句里切换自然。",
        2,
        "mixed",
      ...
      seed(
        "The manager checked the plan.",
        ["ae", "eh"],
        "manager/plan 大，checked 小。",
        "plan 变成 plen。",
        "多音节和单音节都稳。",
        3,
        "mixed",
      ...
      seed(
        "Every family has a better plan.",
        ["ae", "eh"],
        "family/has/plan 大，every/better 小。",
        "family 开口不够。",
        "自然语速也不混。",
        4,
        "mixed",
      ...
      seed(
        "The red jacket is in the black bag.",
        ["eh", "ae"],
        "red 小，jacket/black/bag 大。",
        "black/bag 收太窄。",
        "连续 /æ/ 都打开。",
        4,
        "mixed",
      ...
      seed(
        "Send the package back after ten.",
        ["eh", "ae"],
        "send/ten 小，package/back/after 大。",
        "package 的 /æ/ 被弱化过头。",
        "节奏里开口仍清楚。",
        5,
        "mixed",
      ...
      seed(
        "Dan read the message and felt happy.",
        ["ae", "eh"],
        "Dan/happy 大，read/message/felt 小。",
        "happy 的 /æ/ 像 /e/。",
        "尾句自然但对比明确。",
        5,
        "mixed",
    ...
    shadowing: [
      seed(
        "Ben packed a red bag and left it on the desk.",
        ["eh", "ae"],
        "小开口和大开口交替，不要一快就合并。",
        "句子速度上来后全变 /e/。",
        "bag/desk 对比稳定。",
      ...
      seed(
        "That manager has a better answer for the team.",
        ["ae", "eh"],
        "that/manager/has/answer 大，better 小。",
        "answer 开口不足。",
        "多音节里也能打开。",
        4,
        "mixed",
      ...
      seed(
        "The family checked the map before they went back.",
        ["ae", "eh"],
        "family/map/back 大，checked/went 小。",
        "map 变成 mep。",
        "信息词都清楚。",
        5,
        "mixed",
  ...
  "s-th": {
    ...
    sentences: [
      ...
      seed(
        "Think through the third question.",
        ["th"],
        "think/through/third 三连 /θ/。",
        "through 前加元音。",
        "连读时仍有清楚气流。",
        4,
        "initial",
      ...
      seed(
        "Healthy teeth need careful cleaning.",
        ["th"],
        "healthy/teeth 两处目标音。",
        "teeth 尾音变 /s/。",
        "词尾 /θ/ 不被吞。",
      ...
      seed(
        "Both authors thanked the theater staff.",
        ["th"],
        "both/authors/thanked/theater 多位置练习。",
        "复杂句里回到 /s/。",
        "多位置齿间音都保住。",
        5,
        "mixed",
    ...
    shadowing: [
      seed(
        ...
        "连续 /θ/ 里每次都伸舌，但不要停太久。",
        "为了速度全读成 /s/。",
        "自然速度仍能听出 think/through。",
        4,
        "mixed",
      ),
      seed(
        "The path near the theater is smooth and narrow.",
        ["th"],
        "path 词尾和 theater 开头都要清楚。",
        "path 末尾被吞。",
        "词尾到词首切换稳定。",
        4,
        "mixed",
      ...
      seed(
        "Healthy teeth and thoughtful habits matter.",
        ["th"],
        "healthy/teeth/thoughtful 都保留齿间气流。",
        "多音节里齿间音消失。",
        "句子有节奏，目标音不丢。",
        5,
        "mixed",
  ...
  "z-dh": {
    ...
    sentences: [
      ...
      seed(
        "Rather than rushing, say this slowly.",
        ["dh"],
        "rather/than/this 都要轻。",
        "than 读成 zan。",
        "节奏自然但目标音在。",
        4,
        "mixed",
      ...
      seed(
        "The other team solved the problem.",
        ["dh"],
        "the/other/the 都轻触齿间。",
        "other 中间爆破。",
        "轻读里仍有摩擦。",
      ...
      seed(
        "This weather makes breathing easier.",
        ["dh"],
        "this/weather/breathing 三处练习。",
        "weather 变成 wezzer。",
        "多音节中稳定。",
        5,
        "mixed",
    ...
    shadowing: [
      seed(
        "This weather is better than the weather yesterday.",
        ["dh"],
        "功能词轻读，weather 中间 /ð/ 不变 /z/。",
        "所有 the/this 都缩回。",
        "自然连贯且有齿间振动。",
        4,
        "mixed",
      ...
      seed(
        "They went there together and breathed slowly.",
        ["dh"],
        "there/together/breathed 都保留有声齿间。",
        "breathed 结尾变成 /z/。",
        "句尾仍有振动。",
        4,
        "mixed",
      ...
      seed(
        "My father said this method was smoother than before.",
        ["dh"],
        "father/this/smoother/than 多位置。",
        "中间目标音爆破成 /d/。",
        "多位置有声齿间稳定。",
        5,
        "mixed",
  ...
  "v-w": {
    ...
    sentences: [
      seed(
        "Very warm water is waiting.",
        ["v", "w"],
        "very 是 /v/，warm/water/waiting 是 /w/。",
        "全部开头用同一嘴型。",
        "唇齿和圆唇能切换。",
        2,
        "mixed",
      ...
      seed(
        ...
        ["v", "w"],
        "we 是 /w/，visited/very/village 是 /v/。",
        "village 开头变 /w/。",
        "多处 /v/ 摩擦稳定。",
        3,
        "mixed",
      ...
      seed(
        "The voice on the video was wonderful.",
        ["v", "w"],
        "voice/video 用 /v/，was/wonderful 用 /w/。",
        "video 变成 wideo。",
        "自然句里不混。",
        3,
        "mixed",
      ...
      seed(
        "Victor waited by the window.",
        ["v", "w"],
        "Victor /v/，waited/window /w/。",
        "waited 读成 vaited。",
        "人名和动作词都清楚。",
        3,
        "mixed",
      ...
      seed(
        "Every week we review vocabulary.",
        ["v", "w"],
        "every/review/vocabulary 有 /v/，week/we 有 /w/。",
        "review 中间 /v/ 丢掉。",
        "快读也保留对比。",
        4,
        "mixed",
      ...
      seed(
        "Vivian wore a white vest.",
        ["v", "w"],
        "Vivian/vest 用 /v/，wore/white 用 /w/。",
        "white 开头像 /v/。",
        "两种嘴型切换明确。",
        4,
        "mixed",
      ...
      seed(
        "The warm wave moved very slowly.",
        ["w", "v"],
        "warm/wave 用 /w/，moved/very 用 /v/。",
        "moved 结尾 /v/ 不清楚。",
        "词首词尾都稳定。",
        5,
        "mixed",
      ...
      seed(
        "We value clear vowels and word stress.",
        ["v", "w"],
        "value/vowels 是 /v/，we/word 是 /w/。",
        "value 开头不咬唇。",
        "句子主题词都清楚。",
        5,
        "mixed",
    ...
    shadowing: [
      seed(
        "Very warm water was waiting by the window.",
        ["v", "w"],
        "v 和 w 高频切换，先慢后自然。",
        "所有开头同一个嘴型。",
        "唇齿和圆唇切换稳定。",
      ...
      seed(
        "We reviewed the video and voted on Wednesday.",
        ["v", "w"],
        "we/Wednesday 圆唇，reviewed/video/voted 唇齿。",
        "reviewed 的 /v/ 弱化丢失。",
        "连读时 /v/ 不消失。",
        4,
        "mixed",
      ...
      seed(
        "Vivian's voice was very warm and welcoming.",
        ["v", "w"],
        "voice/very 用 /v/，was/warm/welcoming 用 /w/。",
        "voice 开头变 /w/。",
        "整句温和但对比清楚。",
        5,
        "mixed",
  ...
  "l-r": {
    ...
    words: [
      ...
      seed(
        "right",
        ["r"],
        "舌体形成收缩，可用 bunched 或 retroflex，通常不碰上颚。",
        "读成 light。",
        "开头形成稳定 /ɹ/ 收缩。",
        1,
        "initial",
    ...
    sentences: [
      ...
      seed(
        "Please read the long list.",
        ["l", "r"],
        "read 是 /r/，long/list 是 /l/。",
        "read 变成 lead。",
        "三处舌位分开。",
        2,
        "mixed",
      ...
      seed(
        "The glass is on the green grass.",
        ["l", "r"],
        "glass /l/，green/grass /r/。",
        "glass 和 grass 混。",
        "辅音群稳定。",
        3,
        "mixed",
      ...
      seed(
        "Laura wrote a really clear report.",
        ["l", "r"],
        "Laura/clear 有 /l/，wrote/really/report 有 /r/。",
        "really 的 r-l 切换不清楚。",
        "多位置切换自然。",
        4,
        "mixed",
      ...
      seed(
        "The local rule is rarely clear.",
        ["l", "r"],
        "local/rule/rarely/clear 多次切换。",
        "rule 开头变 /l/。",
        "重复也不混。",
        4,
        "mixed",
      ...
      seed(
        "Fresh rice and cold lemon tea are ready.",
        ["l", "r"],
        "fresh/rice/ready 用 /r/，cold/lemon 用 /l/。",
        "rice 变 lice。",
        "食物词都清楚。",
        4,
        "mixed",
      ...
      seed(
        "Her world feels larger after every lesson.",
        ["l", "r"],
        "world/larger/lesson 练 r-l 过渡。",
        "world 末尾吞掉。",
        "复杂词仍完成舌位。",
        5,
        "mixed",
      ...
      seed(
        "Really listen before you reply.",
        ["l", "r"],
        "really 的 r-l，listen 的 /l/，reply 的 /r/。",
        "reply 开头像 /l/。",
        "自然建议句里不混。",
        5,
        "mixed",
    ...
    shadowing: [
      seed(
        "Turn right at the light and read the long list.",
        ["l", "r"],
        "right/light/read/long/list 连续切换。",
        "开头音互换。",
        "句子里每个关键词清楚。",
        4,
        "mixed",
      ...
      seed(
        "The glass on the grass looked really clear.",
        ["l", "r"],
        "glass/grass/really/clear 是核心。",
        "辅音群里 /l/ 或 /r/ 丢。",
        "自然跟读时不混。",
        4,
        "mixed",
      ...
      seed(
        "Laura rarely writes long reports after lunch.",
        ["l", "r"],
        "Laura/rarely/writes/long/reports/lunch 多位置。",
        "速度上来后舌位塌掉。",
        "多位置切换稳定。",
        5,
        "mixed",
  ...
  "final-consonants": {
    ...
    sentences: [
      ...
      seed(
        "Please help Mark with the task.",
        ["p", "k"],
        "help/Mark/task 的词尾。",
        "help 加尾音或吞 /p/。",
        "每个结尾都短。",
      ...
      seed(
        "The first world map looked old.",
        ["t", "d"],
        "first/world/looked/old 词尾信息。",
        "world 末尾丢 /ld/。",
        "句末也完整。",
        4,
        "mixed",
      ...
      seed(
        "Make it short and keep it clear.",
        ["k", "t", "r"],
        "make/it/short/keep/it 结尾。",
        "it 的 /t/ 不见。",
        "虚词尾音轻收。",
        4,
        "mixed",
      ...
      seed(
        "I left my bag on the black desk.",
        ["t", "g", "k"],
        "left/bag/black/desk 多结尾。",
        "black 末尾加元音。",
        "尾音轻但不缺。",
        4,
        "mixed",
      ...
      seed(
        "We helped the team finish the project.",
        ["p", "t"],
        "helped/project 的结尾群。",
        "helped 少 /t/。",
        "辅音群完整。",
      ...
      seed(
        "Don't add a vowel after the final sound.",
        ["d", "l"],
        "final sound 后不加额外元音。",
        "每个结尾都拖成中文式尾音。",
        "收住就停。",
    ...
    shadowing: [
      seed(
        "I will be back next week, so keep the task short.",
        ["k", "t"],
        "back/next/week/keep/task/short 全部短收。",
        "词尾越多越容易吞。",
        "尾音完整但不重。",
        4,
        "mixed",
      ...
      seed(
        "She asked Mark to help with the first draft.",
        ["k", "t", "p"],
        "asked/Mark/help/first/draft 是重点。",
        "asked 和 draft 结尾丢。",
        "复杂辅音群稳定。",
        4,
        "mixed",
      ...
      seed(
        "The old world map looked perfect on the black desk.",
        ["d", "k", "t"],
        "old/world/looked/perfect/black/desk 多结尾。",
        "加元音让节奏变重。",
        "自然语速仍短收。",
        5,
        "mixed",
  ...
  "stress-rhythm": {
    ...
    sentences: [
      ...
      seed(
        "We need to finish it before noon.",
        ["schwa"],
        "need/finish/noon 重，to/it/before 弱。",
        "所有词平均用力。",
        "内容词更突出。",
        4,
        "mixed",
      ...
      seed(
        "The answer is in the middle of the page.",
        ["schwa"],
        "answer/middle/page 重，the/of 弱。",
        "虚词抢节奏。",
        "长句里仍有主干。",
        4,
        "mixed",
      ...
      seed(
        "I was trying to think about the next step.",
        ["schwa"],
        "trying/think/next/step 重。",
        "to/about/the 过重。",
        "节奏有推进。",
        5,
        "mixed",
      ...
      seed(
        "A lot of people are going to ask about it.",
        ["schwa"],
        "lot/people/going/ask 重。",
        "a/of/are/to/about 逐词重读。",
        "长句轻重分层。",
        5,
        "mixed",
      ),
    ...
    shadowing: [
      seed(
        "I want to talk about it, but I need a minute.",
        ["schwa"],
        "want/talk/need/minute 重，to/about/a 弱。",
        "虚词全部抢重音。",
        "听起来像英语节拍而不是逐词读。",
        4,
        "mixed",
      ...
      seed(
        "It's one of the best ways to practice every day.",
        ["schwa"],
        "one/best/ways/practice/day 是中心。",
        "of/the/to/every 过重。",
        "长句有强弱波动。",
        4,
        "mixed",
      ...
      seed(
        "A lot of people are going to ask about the answer.",
        ["schwa"],
        "lot/people/going/ask/answer 重。",
        "弱读缺失。",
        "弱读和连读自然。",
        5,
        "mixed",
  ...
  "oo-uh": {
    syllables: [
      ...
      seed(
        "blue book",
        ["oo", "uh"],
        "blue 的 /uː/ 较高后、圆唇更明显；book 的 /ʊ/ 更松。",
        "只靠长短，没有改变舌位和圆唇。",
        "短语里音质切换稳定。",
        3,
        "mixed",
    ...
    sentences: [
      ...
      seed(
        "Good students choose useful tools.",
        ["uh", "oo"],
        "good 短，students/useful/tools 长。",
        "good 拖长。",
        "多音节里仍分明。",
        4,
        "mixed",
      ...
      seed(
        "Could you move the blue book?",
        ["uh", "oo"],
        "could/book 短，move/blue 长。",
        "could 读成长 /uː/。",
        "问句自然。",
        4,
        "mixed",
      ...
      seed(
        "The cook used a wooden spoon.",
        ["uh", "oo"],
        "cook/wooden 短，used/spoon 长。",
        "cook 读成 kook。",
        "厨房词不混。",
        4,
        "mixed",
      ...
      seed(
        "Luke took the full box to school.",
        ["oo", "uh"],
        "Luke/school 长，took/full 短。",
        "took 拖长。",
        "多处长短稳定。",
        5,
        "mixed",
      ...
      seed(
        "The new music sounded good in the room.",
        ["oo", "uh"],
        "new/music/room 长，good 短。",
        "good 过长。",
        "自然语流里对比清楚。",
        5,
        "mixed",
    ...
    shadowing: [
      seed(
        "Look at the blue book near the school pool.",
        ["oo", "uh"],
        "blue/school/pool 长，look/book 短。",
        "短音拖成长音。",
        "长短在同一句里稳定。",
        4,
        "mixed",
      ...
      seed(
        "The cook put good food on the wooden table.",
        ["oo", "uh"],
        "cook/put/good/wooden 短，food 长。",
        "food 和 foot 混。",
        "语速自然但长短分明。",
        4,
        "mixed",
      ...
      seed(
        "Luke chose useful tools for the full room.",
        ["oo", "uh"],
        "Luke/chose/useful/tools/room 长，full 短。",
        "full 拉成长音。",
        "多音节里时长稳定。",
        5,
        "mixed",
  ...
  "n-ng": {
    ...
    sentences: [
      seed(
        "I can sing a long song.",
        ["ng"],
        "sing/long/song 都是后鼻音。",
        "后鼻音变前鼻音。",
        "每个 /ŋ/ 不加 /g/。",
        2,
        "final",
      ...
      seed(
        "Nine singers sang one song.",
        ["n", "ng"],
        "nine/one 前鼻，singers/sang/song 后鼻。",
        "前后鼻音混。",
        "两种鼻音分开。",
        4,
        "mixed",
      ...
      seed(
        "The king ran in the rain.",
        ["n", "ng"],
        "king 后鼻，ran/in/rain 前鼻。",
        "king 读成 kin。",
        "对比清楚。",
        4,
        "mixed",
      ...
      seed(
        "Running in the morning feels relaxing.",
        ["n", "ng"],
        "running/morning/relaxing 结尾 /ŋ/。",
        "每个 ing 加 /g/。",
        "自然语流不加爆破。",
        4,
        "final",
      ...
      seed(
        "The young engineer is learning English.",
        ["ng"],
        "young/engineer/learning/English 多处 /ŋ/。",
        "English 开头鼻音位置不稳。",
        "复杂词稳定。",
        5,
        "mixed",
      ...
      seed(
        "Hang the green sign near the window.",
        ["n", "ng"],
        "hang/green/sign 的鼻音不同。",
        "sign 结尾加 /g/。",
        "前后鼻音按词切换。",
        5,
        "mixed",
    ...
    shadowing: [
      seed(
        "I can sing a long song in the morning.",
        ["n", "ng"],
        "sing/long/song/morning 后鼻，in 前鼻。",
        "所有鼻音读成 /n/。",
        "后鼻音不加 /g/。",
        4,
        "mixed",
      ...
      seed(
        "Nine singers are learning English together.",
        ["n", "ng"],
        "nine 前鼻，singers/learning/English 后鼻。",
        "ing 结尾加 /g/。",
        "长句鼻音位置稳定。",
        4,
        "mixed",
      ...
      seed(
        "The young king ran along the green wing.",
        ["n", "ng"],
        "young/king/along/green/wing 多处后鼻。",
        "king/wing 读成 kin/win。",
        "多处后鼻音轻收。",
        5,
        "mixed",
      ),
...
function buildPerceptionLevel(pack: TrainingPack): TrainingLevel {
  ...
  const pairs = (catalog?.examples ?? []).map((example) => ({
    wordA: example.wordA,
    ipaA: "",
    phonemeA: catalog?.categoryA.targetUnit ?? pack.targetPhonemes[0] ?? "",
    wordB: example.wordB,
    ipaB: "",
    phonemeB:
      catalog?.categoryB.targetUnit ??
      pack.contrastPhonemes?.[0] ??
      pack.targetPhonemes[1] ??
      "",
  }));
  return {
    id: "perception-abx",
...
function buildArticulationLevel(pack: TrainingPack): TrainingLevel {
  ...
  return {
    ...
    criterion: CRITERIA.articulation,
    items,
  };
}
...
function wordItemsFromPack(pack: TrainingPack): TrainingCourseItem[] {
  ...
  const fromWords = pack.wordLadder.map((word, index) =>
    courseItem(
      ...
      ) as TrainingCourseItem["difficulty"],
      word.ipa,
      undefined,
      {
...
function buildPairLevel(pack: TrainingPack): TrainingLevel {
  ...
  return {
    ...
    criterion: CRITERIA["minimal-pair"],
...
function buildSentenceLevel(pack: TrainingPack): TrainingLevel {
  ...
  return {
    ...
    coachCue: "先读慢，目标音过线后再恢复自然速度。",
    criterion: CRITERIA.sentence,
    items: cycle([...pack.sentenceLadder, ...generated], 8).map(
      (sentence, index) =>
        courseItem(
          `sentence-${index + 1}`,
          sentence.text,
...
function buildMixedReviewLevel(pack: TrainingPack): TrainingLevel {
  ...
  return {
    ...
    criterion: CRITERIA["mixed-review"],
