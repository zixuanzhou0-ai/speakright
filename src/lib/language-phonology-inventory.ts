...
const RUSSIAN_INVENTORY_BASE: PhonologyInventoryBaseEntry[] = [
  ...
  row(
    "ru-f",
    "phoneme",
    "Hard Russian /f/ fricative anchor; soft /fʲ/ remains a separate contrast target.",
    [...RUSSIAN_CORE_SOURCES, "seeing-speech-ru"],
  ),
  row(
    "ru-v",
    "phoneme",
    "Hard Russian /v/ fricative anchor; /v/ assimilation behavior stays in the rule layer.",
    [...RUSSIAN_CORE_SOURCES, "seeing-speech-ru"],
  ),
  row(
    "ru-s",
    "phoneme",
    "Hard Russian /s/ fricative anchor; soft /sʲ/ remains a separate contrast target.",
    [...RUSSIAN_CORE_SOURCES, "seeing-speech-ru"],
  ),
  row(
    "ru-z",
    "phoneme",
    "Hard Russian /z/ fricative anchor; final devoicing and soft /zʲ/ are trained separately.",
    [...RUSSIAN_CORE_SOURCES, "seeing-speech-ru"],
  ),
  row(
    "ru-m",
    "phoneme",
    "Hard Russian /m/ nasal anchor; soft /mʲ/ remains a separate contrast target.",
    [...RUSSIAN_CORE_SOURCES, "seeing-speech-ru"],
  ),
  row(
    "ru-n",
    "phoneme",
    "Hard Russian /n/ nasal anchor; soft /nʲ/ remains a separate contrast target.",
    [...RUSSIAN_CORE_SOURCES, "seeing-speech-ru"],
  ),
  row(
    "ru-l",
    "phoneme",
    "Hard Russian /l/ lateral anchor; soft /lʲ/ remains a separate contrast target.",
    [...RUSSIAN_CORE_SOURCES, "seeing-speech-ru"],
  ),
  row(
    "ru-hard-soft",
  ...
  row(
    ...
    [...RUSSIAN_CORE_SOURCES, "seeing-speech-ru"],
    ["The grouped contrast stays unclickable; standalone /ʂ/ and /ʐ/ units carry exact tile audio."],
  ),
  row("ru-sh", "phoneme", "Always-hard retroflex-like fricative /ʂ/.", [
    ...RUSSIAN_CORE_SOURCES,
    "seeing-speech-ru",
  ]),
  row("ru-zh", "phoneme", "Always-hard voiced retroflex-like fricative /ʐ/.", [
    ...RUSSIAN_CORE_SOURCES,
    "seeing-speech-ru",
  ]),
  row(
  ...
  row(
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /t/ now has a standalone exact clip; soft /tʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-d-dj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /d/ now has a standalone exact clip; soft /dʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-soft-s-z",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Standalone hard /s z/ clips now exist; exact soft-fricative and pair-lesson clips are still incomplete."],
  ),
  row(
    "ru-soft-n-l-r",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Standalone hard /n l r/ clips now exist; exact soft-sonorant and pair-lesson clips are still incomplete."],
  ),
  row(
    "ru-s-sj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /s/ now has a standalone exact clip; soft /sʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-z-zj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /z/ now has a standalone exact clip; soft /zʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-n-nj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /n/ now has a standalone exact clip; soft /nʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-l-lj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /l/ now has a standalone exact clip; soft /lʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-r-rj",
    "contrast",
  ...
  row(
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /p/ now has a standalone exact clip; soft /pʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-b-bj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /b/ now has a standalone exact clip; soft /bʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-m-mj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /m/ now has a standalone exact clip; soft /mʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-f-fj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /f/ now has a standalone exact clip; soft /fʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-v-vj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /v/ now has a standalone exact clip; soft /vʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-k-kj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /k/ now has a standalone exact clip; soft /kʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-g-gj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /g/ now has a standalone exact clip; soft /gʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-x-xj",
    "contrast",
    ...
    [...RUSSIAN_CORE_SOURCES, "wiktionary-ru-pronunciation-appendix"],
    ["Hard /x/ now has a standalone exact clip; soft /xʲ/ and pair-lesson clips are still missing."],
  ),
  row(
    "ru-soft-sign",
    "contrast",
