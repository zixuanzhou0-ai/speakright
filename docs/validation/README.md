...
Real user-testing results may be published only through [`USER_TESTING_SUMMARY.md`](USER_TESTING_SUMMARY.md) after its publication gate is satisfied. Repository activity, automated test cases, contributors, stars, clones, release downloads, and provider calls are not interchangeable with users.
